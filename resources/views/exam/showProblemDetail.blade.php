        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red bold uppercase">Đề bài</span>
                </div>
                <div class="actions">
                    <div class="btn-group">
    ...
    <div class="col-md-8">
        <div role="tabpanel">
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation"><a class="font-red" href="#editor-box" aria-controls="editor-box" role="tab" data-toggle="tab" aria-expanded="false">Mã nguồn</a></li>
                <li role="presentation"><a class="font-red" href="#result" aria-controls="submit" role="tab" data-toggle="tab" aria-expanded="false">Kết quả</a></li>
            </ul>
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane {{Session::get('is_submitted') == true ? '' : 'active'}}" id="editor-box">
                    {!! Form::open([
                            'action' => array('JudgeController@submit', $exam_id, $problem->problem_id),
                            'method' => 'post',
                        ]) !!}
                    <div class="panel">
                        <div class="portlet light bordered">
                            <div class="portlet-title" style="height: 50px">
                                ...
                                <div class="actions">
                                    <div class="btn-group">
                                        <div class="btn red btn-outline btn-square btn-sm pull-right" id="expand-button">
                            ...
                            <div class="portlet-body">
                                ...
                                <div class="scroller-footer">
                                    <div class="form-group">
                                        <div>
                                            <button class="btn red pull-right" type="submit" id="submit-button">
                                                Submit
                                            </button>
                                        </div>
                                    </div>
