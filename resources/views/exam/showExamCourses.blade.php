    ...
    <table class="table-display">
        ...
        @foreach ($exams as $exam)
            <tr>
                ...
                <td>
                    @if (!$exam->completed)
                        <a class="btn sbold btn-outline red" data-toggle="modal" data-target="#enroll-modal-{{$exam->exam_id}}">Bắt đầu thi</a>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn yellow-gold" data-dismiss="modal" onclick="location.href='{{url('/exams/'.$exam->exam_id)}}';">Đồng ý</button>
