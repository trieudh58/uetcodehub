    ...
    <table class="table-display">
        ...
        @foreach ($courses as $course)
            <tr>
                ...
                @if (!$course->joined)
                <td>
                    <a class="btn sbold btn-outline yellow-gold" data-toggle="modal" data-target="#enroll-modal">Tham gia</a>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <div class="form-group" style="margin-right: 5px">
                                        <div>
                                            <button type="submit" class="btn sbold btn-outline yellow-gold">
                                                Tham gia lớp
                                            </button>
